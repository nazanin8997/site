 ...
 <div class="clear"></div>
  ...
  <!-- Begin Navigation -->
		<div id="navigation">
			...
			<div class="shell">
				<ul>
					<li class="active"><a href="home.php" title="Home">صفحه اصلی</a></li>
		...
		<div id="main" class="shell">
			...
			<div id="content">
				<div class="post">
					...
					باتشکر از زحمات و راهنمایی‌های استاد عزیز سرکار خانم مریم صداقتی <a href="#" class="more" title="Read More"></a></p>
					<div class="cl">&nbsp;</div>
				</div>
			</div>
			<!-- End Content -->
